...
(async () => {
  ...
  const fields_invitee_table = `INSERT INTO 
    invitee(invitee_name,invited_by ) 
    VALUES('Mohammad', 'Omar'),
      ('Wouter','Fede'),
      ('Khaled','Sami'),
      ('Hanin','Fatima'),
      ('Wissam','Amjad')`;
  const fields_room_table = `INSERT INTO 
    room(room_name,floor_number ) 
    VALUES('Kitchen', 0),
      ('Waiting room',1),
      ('Dining room',1),
      ('meeting room',5),
      ('Living room',2)`;
  const fields_meeting_table = `INSERT INTO 
